      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-12">
          ...
          <a
            ...
            className="group flex items-center gap-3 px-8 py-4 border-2 border-paper/30 text-paper font-body font-medium text-sm uppercase tracking-wider no-underline transition-all hover:bg-paper hover:text-charcoal"
          >
            <svg
              width="18"
              height="18"
